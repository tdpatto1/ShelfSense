...
Easiest option: double-click `start_demo.bat` inside this `mvp` folder. It installs dependencies, starts the demo, and keeps the window open if there is an error.
